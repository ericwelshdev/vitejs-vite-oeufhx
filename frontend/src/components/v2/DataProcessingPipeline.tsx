...
const DataProcessingPipeline: React.FC<DataProcessingPipelineProps> = ({
  ...
  const handleProcessing = async () => {
    ...
    try {
      ...
      const enhancedDataset = await runDataProcessingPipeline(simulatedFilePath, sourceSchema, targetSchema);
      ...
      setError('An error occurred while processing the data. Please check your OpenAI API key and try again.');
    } finally {
